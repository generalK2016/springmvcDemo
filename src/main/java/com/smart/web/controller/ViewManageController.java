...
public class ViewManageController extends BaseController {
    ...
    public  Map<String ,Object> showUserInfos(){
        ...
        List<Map<String,Object>> list = viewSpaceService.searchUserByJdbc();
    ...
    // 进入echart页面
    @RequestMapping(value = "/towebservice", method = RequestMethod.GET)
    public String towebservice() {

        return "webservice/webservicePage";
    }

    // 进入echart页面
    @RequestMapping(value = "/toEchart", method = RequestMethod.GET)
    public String toEchart() {

        return "echartPage/echartValue";
    }
    ...
    public String toUpLoad(HttpServletRequest request) {
        ...
        return "uploadPage/productForm";
    }

    @RequestMapping(value = "/saveUpload", method = RequestMethod.POST)
    public String addViewPoint(MultipartHttpServletRequest request) {
        return "";
    }
    ...
    public String deleteViewPoint(@PathVariable Integer id) {
        ...
        viewSpaceService.deleteViewPoint(id, spaceId);
        String targetUrl = "/vs/" + spaceId + "/edit.html";
        return "redirect:" + targetUrl;
    }
